...
module Bitcoin
  ...
  NETWORKS[:c0ban] = NETWORKS[:bitcoin].merge({
    project: :c0ban,
    magic_head: "\x63\x30\x62\x6E",
    message_magic: "c0ban Signed Message:\n",
    address_version: "12",
    p2sh_version: "1c",
    privkey_version: "88",
    bech32_hrp: nil,
    ...
    per_dust_fee: true,
    coinbase_maturity: 30,
    coinbase_maturity_new: 100,
    reward_base: 1 * COIN,
    reward_halving: 100_000,
    retarget_interval: 1,
    retarget_time: 32, # 4 hours
    retarget_time_new: 32, # 1 minute
    target_spacing: 32, # block interval
    dns_seeds: [
